#
# Like secp256k1 the famous curve used by Bitcoin
#
prime = 12 * 2**160 + 10331
a,b = 0,7
...
def nextPrime_(p):
  ...
  while True:
    ...
    return p
#
# 160 Bits - it's more than enough!
#
#prime = nextPrime(12 * 2**160)
print "A prime greater than 12 times 2^160 \np = ", prime

#
# The sequence of points repeats after r steps.
#
r = (prime + 1) / 12
...
#X = 2**80
#for x in range(1000):
#  wa(mulP(Q,x+2)[1] % X,'test') 
#  wa(mulP(Q,x+2)[0] % X,'test') 

print prime -12*2**160