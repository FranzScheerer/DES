...
afactor =  
bfactor =  2
...
if len(sys.argv) == 3 and sys.argv[1] == "G":
  ...
  p = nextPrime3( hg(sys.argv[2]) % (2**501 + 1) )  
  q = nextPrime7( hg(sys.argv[2] + '0') % (2**501 + 1) )  
  writeNumber(p, 'p_')                     
  writeNumber(q, 'q_')     
  print "nrabin = ", (p * q) 
  print "\ncrabin = \n", num2code(p * q) 
  print "afactor = ", nrabin - 2             
  print "bfactor = ", 2
  print "check ", pow(2, (q-1)/2, q) == q - 1             
